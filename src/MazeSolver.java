...
public abstract class MazeSolver
{
    ...
    public boolean setGoal(int r, int c)
    {
       ...
       // TODO Project #5
        if(isLegal(r,c) && isOpen(r,c))
        {
            this.goalRow = r;
            this.goalCol = c;
            this.squares[r][c] = GOAL; //sets this spot to the value of GOAL, recognized as 5 by the game, displayed as G in game
            goalOK = true;
        }
        return goalOK;
    } // end setGoal
    ...
    public boolean isLegal(int r, int c)
    {
        ...
        return legality; // THIS IS A STUB
    } // end isLegal
    ...
    {
        boolean openness = false;
        // TODO Project #5
        //     any of the following states should be considered open: EMPTY, GOAL, PLAYER
        if(squares[r][c] == EMPTY || squares[r][c] == GOAL || squares[r][c] == PLAYER){
            openness = true;
        }

        return openness; // THIS IS A STUB
    } // end isOpen
